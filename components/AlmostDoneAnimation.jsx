...
const AlmostDoneAnimation = React.createClass({
   
    render: function() {
        return (
			<div>
				<svg id="Livello_1" x="0px" y="0px" width="100px" height="100px" viewBox="0 0 100 100" className="almost-done__svg">
				...
				<path className="almost-done__fill" d="M70.5,23v36.3c0,1.4-0.8,3.2-2.2,3.2H31.7c-1.4,0-3.2-1.8-3.2-3.2V23"/>
				<polyline className="almost-done__fill" points="42.6,75.5 49.3,68.5 56.2,75.5 "/>
				<polygon className="almost-done__fill" points="50,29.6 52.6,37.5 60.9,37.5 54.2,41.9 56.8,49.5 50,44.5 43.2,49.3 45.8,41.9 39.1,37.5 47.4,37.5 "/>
